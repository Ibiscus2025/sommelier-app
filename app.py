...
with st.sidebar:
    ...
    # Όταν το κλειδί υπάρχει ήδη ως environment variable (π.χ. στα Secrets
    # του Streamlit Cloud), δεν εμφανίζουμε κανένα μήνυμα ή πεδίο — μένει
    # εντελώς αόρατο στον χρήστη, χωρίς περιττό "τεχνικό" θόρυβο στο UI.
